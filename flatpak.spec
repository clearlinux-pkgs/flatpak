...
%prep
%setup -q -n flatpak-1.12.2
cd %{_builddir}/flatpak-1.12.2
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
cp %{_builddir}/flatpak-1.12.2/subprojects/libglnx/COPYING %{buildroot}/usr/share/package-licenses/flatpak/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
%find_lang flatpak
...
/usr/lib64/libflatpak.so.0.11202.0
