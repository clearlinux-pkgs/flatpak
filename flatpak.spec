...
Version  : 0.10.4
Release  : 21
URL      : https://github.com/flatpak/flatpak/releases/download/0.10.4/flatpak-0.10.4.tar.xz
Source0  : https://github.com/flatpak/flatpak/releases/download/0.10.4/flatpak-0.10.4.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1518613286
...
/usr/lib64/libflatpak.so.0.1004.0
