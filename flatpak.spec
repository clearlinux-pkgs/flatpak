...
Version  : 0.8.5
Release  : 12
URL      : https://github.com/flatpak/flatpak/releases/download/0.8.5/flatpak-0.8.5.tar.xz
Source0  : https://github.com/flatpak/flatpak/releases/download/0.8.5/flatpak-0.8.5.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1494944510
...
/usr/lib64/libflatpak.so.0.800.5
