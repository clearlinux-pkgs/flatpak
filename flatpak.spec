...
Version  : 1.6.2
Release  : 57
URL      : https://github.com/flatpak/flatpak/releases/download/1.6.2/flatpak-1.6.2.tar.xz
Source0  : https://github.com/flatpak/flatpak/releases/download/1.6.2/flatpak-1.6.2.tar.xz
...
%prep
%setup -q -n flatpak-1.6.2
cd %{_builddir}/flatpak-1.6.2
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581694533
...
cp %{_builddir}/flatpak-1.6.2/COPYING %{buildroot}/usr/share/package-licenses/flatpak/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/flatpak-1.6.2/libglnx/COPYING %{buildroot}/usr/share/package-licenses/flatpak/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
%find_lang flatpak
...
/usr/lib64/libflatpak.so.0.10602.0
