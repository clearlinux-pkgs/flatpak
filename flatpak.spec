...
Source0  : https://github.com/flatpak/flatpak/releases/download/1.14.0/flatpak-1.14.0.tar.xz
...
%prep
%setup -q -n flatpak-1.14.0
cd %{_builddir}/flatpak-1.14.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664429600
...
/usr/lib64/libflatpak.so.0.11400.0
