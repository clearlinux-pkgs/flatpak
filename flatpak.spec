...
Version  : 0.10.0
Release  : 16
URL      : https://github.com/flatpak/flatpak/releases/download/0.10.0/flatpak-0.10.0.tar.xz
Source0  : https://github.com/flatpak/flatpak/releases/download/0.10.0/flatpak-0.10.0.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1509032266
...
/usr/lib64/libflatpak.so.0.1000.0
