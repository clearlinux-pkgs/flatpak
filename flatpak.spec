...
Source0  : https://github.com/flatpak/flatpak/releases/download/1.8.2/flatpak-1.8.2.tar.xz
...
%prep
%setup -q -n flatpak-1.8.2
cd %{_builddir}/flatpak-1.8.2
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605570112
...
cp %{_builddir}/flatpak-1.8.2/COPYING %{buildroot}/usr/share/package-licenses/flatpak/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/flatpak-1.8.2/libglnx/COPYING %{buildroot}/usr/share/package-licenses/flatpak/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
%find_lang flatpak
...
/usr/lib64/libflatpak.so.0.10802.0
