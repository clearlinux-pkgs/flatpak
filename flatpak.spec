...
Version  : 1.6.0
Release  : 55
URL      : https://github.com/flatpak/flatpak/releases/download/1.6.0/flatpak-1.6.0.tar.xz
Source0  : https://github.com/flatpak/flatpak/releases/download/1.6.0/flatpak-1.6.0.tar.xz
...
%prep
%setup -q -n flatpak-1.6.0
cd %{_builddir}/flatpak-1.6.0
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579197981
...
cp %{_builddir}/flatpak-1.6.0/COPYING %{buildroot}/usr/share/package-licenses/flatpak/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/flatpak-1.6.0/libglnx/COPYING %{buildroot}/usr/share/package-licenses/flatpak/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
%find_lang flatpak
...
/usr/lib64/libflatpak.so.0.10600.0
