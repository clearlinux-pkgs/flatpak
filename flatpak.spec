...
Version  : 1.4.0
Release  : 49
URL      : https://github.com/flatpak/flatpak/releases/download/1.4.0/flatpak-1.4.0.tar.xz
Source0  : https://github.com/flatpak/flatpak/releases/download/1.4.0/flatpak-1.4.0.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1560178438
export AR=gcc-ar
...
/usr/lib64/libflatpak.so.0.10400.0
