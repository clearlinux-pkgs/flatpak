...
Source0  : https://github.com/flatpak/flatpak/releases/download/1.14.1/flatpak-1.14.1.tar.xz
...
%prep
%setup -q -n flatpak-1.14.1
cd %{_builddir}/flatpak-1.14.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668793009
...
/usr/lib64/libflatpak.so.0.11401.0
