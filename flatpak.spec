...
Version  : 1.0.5
Release  : 38
URL      : https://github.com/flatpak/flatpak/releases/download/1.0.5/flatpak-1.0.5.tar.xz
Source0  : https://github.com/flatpak/flatpak/releases/download/1.0.5/flatpak-1.0.5.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1542045535
...
/usr/lib64/libflatpak.so.0.10005.0
