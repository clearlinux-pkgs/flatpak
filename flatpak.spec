...
Source0  : https://github.com/flatpak/flatpak/releases/download/1.14.8/flatpak-1.14.8.tar.xz
...
%prep
%setup -q -n flatpak-1.14.8
cd %{_builddir}/flatpak-1.14.8
%patch -P 1 -p1
pushd ..
cp -a flatpak-1.14.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715269756
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libflatpak.so.0.11408.0
/usr/lib64/libflatpak.so.0
/usr/lib64/libflatpak.so.0.11408.0
