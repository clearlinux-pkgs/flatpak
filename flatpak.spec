...
Source0  : https://github.com/flatpak/flatpak/releases/download/1.12.5/flatpak-1.12.5.tar.xz
...
%prep
%setup -q -n flatpak-1.12.5
cd %{_builddir}/flatpak-1.12.5
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644864291
...
cp %{_builddir}/flatpak-1.12.5/COPYING %{buildroot}/usr/share/package-licenses/flatpak/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/flatpak-1.12.5/subprojects/libglnx/COPYING %{buildroot}/usr/share/package-licenses/flatpak/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
%find_lang flatpak
...
/usr/lib64/libflatpak.so.0.11205.0
