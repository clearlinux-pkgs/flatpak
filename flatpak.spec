...
Version  : 1.8.4
Release  : 62
URL      : https://github.com/flatpak/flatpak/releases/download/1.8.4/flatpak-1.8.4.tar.xz
Source0  : https://github.com/flatpak/flatpak/releases/download/1.8.4/flatpak-1.8.4.tar.xz
...
%prep
%setup -q -n flatpak-1.8.4
cd %{_builddir}/flatpak-1.8.4
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609352839
...
cp %{_builddir}/flatpak-1.8.4/COPYING %{buildroot}/usr/share/package-licenses/flatpak/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/flatpak-1.8.4/libglnx/COPYING %{buildroot}/usr/share/package-licenses/flatpak/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
%find_lang flatpak
...
/usr/lib64/libflatpak.so.0.10804.0
